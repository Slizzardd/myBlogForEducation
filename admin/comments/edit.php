    ...
    <div class="posts col-9">
        ...
        <div class="row add-post">
            ...
            <form action="edit.php" method="post">
                ...
                <div class="col mb-4">
                    <input value="<?=$email?>" name="title" type="text" disabled class="form-control" placeholder="Title" aria-label="Article title">
                </div>
                <div class="col">
                    <label for="editor" class="form-label">Commentary</label>
