    ...
    <div class="posts col-9">
        ...
        <div class="row add-post">
            ...
            <form action="edit.php" method="post">
                ...
                <div class="col">
                    <input name="name" value="<?=$name;?>" type="text" class="form-control" placeholder="Name topic" aria-label="Name topic">
                </div>
                <div class="col">
                    <label for="content" class="form-label">Description topic</label>
                    <textarea name="description" class="form-control" id="content" rows="3"><?=$description;?></textarea>
                </div>
                <div class="col">
                    <button name="topic-edit" class="btn btn-primary" type="submit">Update topic</button>
                </div>
            </form>
        </div>
